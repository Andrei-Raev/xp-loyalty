...
func main() {
	...
	{
		// auth
		api.POST("/aauth/sign-in", authHandler.SignIn)
		api.POST("/aauth/sign-up-user", authHandler.SignUpUser)
		apiModerator.POST("/aauth/sign-up-admin", authHandler.SignUpAdmin)
